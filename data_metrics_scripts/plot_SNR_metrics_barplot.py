...
with open(
	'28Jul2021_15-56-56__LR3_1.D_bistTrue_dict_array_snr.pickle',
	'rb') as f:(
	dict_array_snr,
	M_syn,
	correct_response,
...
plt.bar(x+0.4, data_c1_on1[0], width)
plt.bar(x-0.4, data_c1_on1[1], width)
plt.bar(x+0.2, data_c1_on1[2], width)
plt.bar(x-0.2, data_c1_on1[3], width)
plt.bar(x, data_c1_on1[4], width)
...
plt.bar(x+0.4, data_c2_on1[0], width)
plt.bar(x-0.4, data_c2_on1[1], width)
plt.bar(x+0.2, data_c2_on1[2], width)
plt.bar(x-0.2, data_c2_on1[3], width)
plt.bar(x, data_c2_on1[4], width)
...
plt.bar(x+0.4, data_c2_on2[0], width)
plt.bar(x-0.4, data_c2_on2[1], width)
plt.bar(x+0.2, data_c2_on2[2], width)
plt.bar(x-0.2, data_c2_on2[3], width)
plt.bar(x, data_c2_on2[4], width)
...
plt.bar(x+0.4, data_c1_on2[0], width)
plt.bar(x-0.4, data_c1_on2[1], width)
plt.bar(x+0.2, data_c1_on2[2], width)
plt.bar(x-0.2, data_c1_on2[3], width)
plt.bar(x, data_c1_on2[4], width)
