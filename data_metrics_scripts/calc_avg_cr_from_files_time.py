...
# sim_results_path = "C://Users//willi//PhD_Stuff//learning_rule//network_results_CR_varying_time//feedforward_network"

sim_results_path = "C://Users//willi//PhD_Stuff//learning_rule//network_results_CR_varying_time"
...
for folder in dir_list:
	...
	if len(folder_n_files_list) == 1:
		...
		if t_run == 1.25:
			cr_4_epoch.append(correct_rate)
		if t_run == 1.5:
			cr_5_epoch.append(correct_rate)
...
cr_5_epoch_avg = np.mean(cr_5_epoch)
...
cr_5_epoch_std = np.std(cr_5_epoch)

# bar plot with error bar
# x = [1, 2, 3, 4]
x = [0.5, 0.75, 1.0, 1.25, 1.5]
y = [cr_1_epoch_avg, cr_2_epoch_avg, cr_3_epoch_avg, cr_4_epoch_avg, cr_5_epoch_avg]

plt.bar(x, y, width = 0.1)

err_bar = [cr_1_epoch_std, cr_2_epoch_std, cr_3_epoch_std, cr_4_epoch_std, cr_5_epoch_std]
