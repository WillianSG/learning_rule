...
# # varying_params = ['none', 'wmax', 'c', 'tau_pre', 'tau_post', 'rho_neg', 'rho_neg2', 'thr_post', 'thr_pre', 'all']
...
# num_networks = 3				# Total independ. runs for each param varying
# sim_duration = 2*second			# Duration of each simulation
...
# 		fn = os.path.join(sim_results_folder, n.id + '_' + n.exp_type + '.pickle')
...
# 		shutil.move(sim_results_folder, sim_results_folder)

# varying_params_attractor_analysis_plot(
# 	sim_results_folder)

varying_params_attractor_analysis_plot(
	'/home/p302242/PhD_codes/learning_rule/network_results/param_variation/20210309_14_38_50_param_variation')
