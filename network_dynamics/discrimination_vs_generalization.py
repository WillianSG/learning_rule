...
script_results_path = os.path.join(
	network_sim_dir,
	'discrimination_vs_generalizaion')
...
exp_name = '_discrimination_vs_generalizaion'
...
cue_e_ids_no_duplicates = set(cue_e_ids)

# 4 ====================== learning followup stimuli ======================
t_run_count_aux = 0

total_runs = n.stim_size_e
stim_offset = n.stim_size_e

for stimulus in range(0, 1):
	n.net.restore(
		name = 'trained_cue_net_' + simulation_id, 
		filename = os.path.join(
			simulation_results_path,
	...
	print('\n> learning stimulus [ offfseted by: ', str(n.stim_offset_e), ' ]\n')
